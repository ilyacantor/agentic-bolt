function DCLDashboard(){
  const {data:list, error, loading} = useJSON('./src/data/connectors.json');
    ...
    <div className="p-5 w-full">
      <div className="grid grid-cols-12 gap-5 max-w-7xl mx-auto">
        <div className="col-span-12 lg:col-span-3 card">
          ...
          <div className="space-y-3">{loading && <Skeleton className="h-8 w-full mb-2" />} {error && <div className="text-rose-300 text-sm">Failed to load connectors</div>}
            {(list||[]).map(c => (
